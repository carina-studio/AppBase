...
public static class CollectionExtensions
{
	...
	[MethodImpl(MethodImplOptions.AggressiveInlining)]
	public static bool IsNotEmpty<T>([NotNullWhen(true)] this ICollection<T>? collection) => collection is not null && collection.Count > 0;
	...
	[MethodImpl(MethodImplOptions.AggressiveInlining)]
	public static bool IsNullOrEmpty<T>([NotNullWhen(false)] this ICollection<T>? collection) => collection is null || collection.Count <= 0;
